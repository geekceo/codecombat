...
#    meta_og_url: "https://codecombat.com"
    built_for_teachers_title: "Кодовая игра, построенная совместно с менторами"
...
#    built_for_teachers_subblurb2: "Learners construct mazes and use basic input handling to code their own games that can be shared with friends and family."
    built_for_teachers_subtitle3: "Веб разработка"
...
#    century_skills_quote4: "I’ve always had aspirations of designing video games and learning how to code ... this is giving me a great starting point."
    ...
    century_skills_subblurb4: "Кодирование требует от детей практиковать новые формы общения, включая общение с самим компьютером и передачу своих идей с использованием наиболее эффективного кода."
...
#    anon_signup_title_1: "CodeCombat has a"
    anon_signup_title_2: "Версия аудитории!"
#    anon_signup_enter_code: "Enter Class Code:"
#    anon_signup_ask_teacher: "Don't have one? Ask your teacher!"
    anon_signup_create_class: "Хотите создать урок?"
    anon_signup_setup_class: "Создайте урок, добавьте своих учеников, и наблюдайте за прогрессом!"
    anon_signup_create_teacher: "Создайте бесплатный аккаунт учителя"
  ...
  common:
    default_title: "CodeCombat - Кодовые игры для обучения Python и JavaScript"
...
#    claire_title: "Executive Assistant"
    bobby_title: "Гейм-дизайнер"
    brian_title: "Старший менеджер по гейм-дизайну"
    andrew_title: "Разработчик ПО"
#    stephanie_title: "Customer Support Specialist"
#    rob_title: "Sales Development Representative"
    shubhangi_title: "Старший разработчик"
...
#    estimated_class_frequency_label: "Estimated Class Frequency"
    classes_per_week: "уроков за неделю"
    minutes_per_class: "минут за урок"
...
#    view_ranking: "view ranking"
    ...
    ranking_completed_leves: "Завершенные уровни"
    challenge: "Испытание:"
...
#    hoc_self_led_desc: "Students can play through two Hour of Code CodeCombat tutorials on their own"
    hoc_game_dev: "Разработка игр"
    hoc_and: "и"
    hoc_programming: "JavaScript/Python Програмирование"
...
#    teacher_quest: "Teacher's Quest for Success"
    quests_complete: "Квест выполнен"
